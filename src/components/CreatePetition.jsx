...
function CreatePetition() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center text-white">
            <div className="w-full max-w-lg p-6 bg-[#414264] border border-purple-500 rounded-lg shadow-md">
                ...
                <form className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            id="owner"
                            name="owner"
                            className="mt-1 block w-full p-2  bg-gray-600 rounded-lg focus:ring-4 focus:ring-purple-500"
                            value={owner}
